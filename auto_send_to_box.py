...
TODO:
-delete test files that uploaded correctly
- more intricate testing
...
if __name__ == "__main__":
    ...
    log_file_name= now.strftime("%d-%m-%Y_%H:%M_") + "failed_uploads.log"
    ...
    try:
        ...
        print("Delete file that uploaded correctly")
